...
export BASEROW_GROUP_STORAGE_USAGE_ENABLED="${BASEROW_GROUP_STORAGE_USAGE_ENABLED:-false}"
export BASEROW_GROUP_STORAGE_USAGE_QUEUE="${BASEROW_GROUP_STORAGE_USAGE_QUEUE:-'export'}"
