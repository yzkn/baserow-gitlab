...
class FormulaMigrationHandler:
    ...
    @classmethod
    def migrate_formulas(cls, migrations: typing.List[FormulaMigration]):
        from baserow.contrib.database.fields.models import FormulaField
    ...
    @classmethod
    def _update_formulas(cls, migrations: typing.List[FormulaMigration]):
        from baserow.contrib.database.fields.models import FormulaField
    ...
    @classmethod
    def _get_formula_querysets(cls, migrations: typing.List[FormulaMigration]):
        """
