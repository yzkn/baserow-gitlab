...
def test_get_dependant_fields_with_type(data_fixture):
    ...
    print(text_field_1_dependency_1)
    print(text_field_1_dependency_2)
    print(text_field_2_dependency_1)
    print(text_field_2_dependency_2)
    print(text_field_2_dependency_3)
    print(text_field_1_and_2_dependency_1)
    ...
    assert results[0][0].id == text_field_1_dependency_1.id
    assert results[1][0].id == text_field_1_dependency_2.id
    assert results[2][0].id == text_field_2_dependency_1.id
    assert results[3][0].id == text_field_2_dependency_2.id
    assert results[4][0].id == text_field_2_dependency_3.id
    assert results[5][0].id == text_field_1_and_2_dependency_1.id
