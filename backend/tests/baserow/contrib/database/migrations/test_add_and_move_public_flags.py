...
def test_forwards_migration(data_fixture, transactional_db):
    ...
    migrate_to = [("database", "0050_add_and_move_public_flags")]
...
@pytest.mark.django_db
@patch(
    "baserow.contrib.database.migrations.0050_add_and_move_public_flags"
    ".update_batch_size"
)
...
def test_backwards_migration(data_fixture, transactional_db):
    migrate_from = [("database", "0050_add_and_move_public_flags")]
    migrate_to = [("database", "0049_urlfield_2_textfield")]
